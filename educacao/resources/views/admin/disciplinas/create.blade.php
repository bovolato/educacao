<x-sigem-layout title="Nova Disciplina">
    <x-page-header title="Nova Disciplina" :back-route="route('admin.disciplinas.index')" back-label="Voltar"/>
                ...
                <div class="md:col-span-2">
                    <x-form-field label="Descrição" name="descricao">
                        <textarea name="descricao" rows="3"
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 outline-none text-sm">{{ old('descricao') }}</textarea>
                    </x-form-field>
                </div>
            </div>
        </x-form-card>
