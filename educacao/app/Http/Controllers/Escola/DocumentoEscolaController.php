...
class DocumentoEscolaController extends Controller
{
    ...
    public function index()
    {
        ...
        $documentos = DocumentoEmitido::query()
            ->with(['aluno.usuario', 'matricula.turma', 'emitidoPor'])
    ...
    public function imprimir(DocumentoEmitido $documentoEmitido)
    {
        ...
        $documentoEmitido->load(['aluno.usuario', 'matricula.turma.serie', 'matricula.escola', 'matricula.anoLetivo', 'emitidoPor']);
