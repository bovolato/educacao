<x-sigem-layout title="Editar Professor">
    ...
    <form method="POST" action="{{ route('pessoas.professores.update', $professor) }}" @if(! isset($escolaFixa)) x-data="professorForm()" @endif>
        @csrf @method('PATCH')
        @php
            $pessoaProf = $professor->usuario;
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                @isset($escolaFixa)
                    ...
                    <div class="md:col-span-2 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700">
                        <span class="text-gray-500">Escola de atuação:</span>
