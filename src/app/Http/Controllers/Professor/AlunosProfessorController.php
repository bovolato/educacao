...
class AlunosProfessorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $matriculasQuery = Matricula::query()
            ...
            ->with(['aluno.pessoa', 'turma.escola'])
            ...
            ->when($request->filled('busca'), fn ($q) => $q->where('pessoas.nome', 'like', '%' . $request->busca . '%'))
            ->orderBy('turmas.nome')
    ...
    public function show(Request $request, Matricula $matricula)
    {
        ...
        $matricula->load(['turma.escola', 'aluno.pessoa', 'aluno.responsaveis.pessoa']);
