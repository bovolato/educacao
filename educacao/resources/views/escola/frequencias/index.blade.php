<x-sigem-layout title="Frequência — Escola">
    <x-page-header title="Frequência" subtitle="Visão por turma (somente leitura)"
        ...
        <table class="min-w-full text-sm">
            <thead class="bg-gray-50 text-left text-gray-600">
                <tr>
                    ...
                    <th class="px-5 py-3 font-medium text-center">Aulas realizadas</th>
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse($turmas as $turma)
                    <tr class="hover:bg-gray-50/80">
                        ...
                        <td class="px-5 py-3 text-center text-gray-700">{{ $turma->aulas_realizadas_count }}</td>
                        <td class="px-5 py-3 text-right">
                            <a href="{{ route('escola.frequencias.turma', $turma) }}" class="text-indigo-600 hover:underline font-medium">Detalhar</a>
                        </td>
                    </tr>
                @empty
